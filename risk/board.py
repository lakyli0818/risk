...
class Board(object):
    ...
    def shortest_path(self, source, target):
        ...
        while q:
            ...
            neighbor_ids = risk.definitions.territory_neighbors[current_territory]
            for t in neighbor_ids:
                if t not in visited_territory: 
                    Dict_copy = deepcopy(Dict[current_territory])
                    Dict_copy.append(t)
                    Dict[t] = Dict_copy
                    q.append(t)
                visited_territory.add(t)
    ...
    def can_fortify(self, source, target):
        ...
        while q:
            ...
            for t in neighbor_ids:
                ...
                if t not in visited_territory and neighbor_id == player_id:
                    Dict_copy = deepcopy(Dict[current_territory])
                    Dict_copy.append(t)
                    Dict[t] = Dict_copy
                    q.append(t)
    ...
    def cheapest_attack_path(self, source, target):
        ...
        visited_territory.add(source)
        while hd:
            (current_territory,priority) = hd.popitem()
            if current_territory == target:
            ...
            for t in neighbor_ids:
                ...
                if t not in visited_territory and neighbor_owner != player_id:
                    Dict_copy = deepcopy(Dict[current_territory])
                    Dict_copy.append(t)
